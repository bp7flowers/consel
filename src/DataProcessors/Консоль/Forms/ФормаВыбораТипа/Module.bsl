...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Исходный код модифицирован и перемещён в процедуру СформироватьСтруктуруТипов() модуля объекта.
	Если НЕ Хранилище.Свойство("СтруктураТипов") Тогда
		ОбОбъект = РеквизитФормыВЗначение("Объект");
		СтруктураТипов = ОбОбъект.СформироватьСтруктуруТипов();
	...
	ЭтотОбъект.СписокЗначений = ТекПараметр.ОграничениеТипов.СписокЗначений;
	Массив = Новый Массив;
	...
	ЗначениеВДанныеФормы(Таблица, ДополнительныеТипы);
...
Процедура ОбновитьОтображение()
	...
	Элементы.ДополнительныеТипы.Видимость	= ВидТипа = 1;
...
Процедура ОписатьТип()
	...
	Если ВидТипа = 1 Тогда // Дополнительно
		...
		Таблица = ДанныеФормыВЗначение(ДополнительныеТипы, Тип("ТаблицаЗначений"));
...
&НаКлиенте
Процедура ДополнительныеТипыВыбратьПриИзменении(Элемент)

	Идентификатор = Элементы.ДополнительныеТипы.ТекущиеДанные.ПолучитьИдентификатор();
	Для Каждого Строка Из ДополнительныеТипы Цикл
...
Процедура ДобавитьКомментарий(Команда)
	...
	ЭтотОбъект.ТекущийЭлемент = Элементы.ТекстМодуля;
