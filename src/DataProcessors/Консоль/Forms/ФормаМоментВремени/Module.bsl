...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ПараметрСсылка", ПараметрСсылка) Тогда
		ЭтотОбъект.Ссылка = ПараметрСсылка;
		М = Новый Массив;
	...
	ИначеЕсли Параметры.Свойство("ОтборПараметрЗапроса", Отбор) Тогда
		...
		ЭтотОбъект.Ссылка = ПараметрМВ.Ссылка;
...
Процедура ОкНаСервере(СтрокаПредставления)
	...
	Парам[0] = ЭтотОбъект.Ссылка.Дата;
	Парам[1] = ЭтотОбъект.Ссылка;
...
Процедура СсылкаПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(ЭтотОбъект.Ссылка) Тогда
		М = Новый Массив;
		М.Добавить(ТипЗнч(ЭтотОбъект.Ссылка));
